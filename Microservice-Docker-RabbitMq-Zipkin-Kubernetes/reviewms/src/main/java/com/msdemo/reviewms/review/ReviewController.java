package com.msdemo.reviewms.review;

import com.msdemo.reviewms.review.messaging.ReviewMessageProducer;
...
public class ReviewController {
    ...
    public Double getAvgReview(@RequestParam("companyId") Long companyId){
